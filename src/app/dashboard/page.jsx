...
function page() {
  ...
  return (
    <>
      {toggle ? (
        <div
          className={`bg-blue-700 shadow_pri lg:hidden ${
            toggle === false
              ? "w-[0%]"
              : "max-[321px]:w-[14rem] w-[16.5rem] absolute top-0 left-0"
          }  lg:w-[20%] xl:w-[18%] min-[1450px]:w-[14%] h-full lg:relative overflow-y-auto transition-all duration-300 z-50`}
        >
          <div
            className={`border-2 border-white w-full max-[321px]:h-[5rem]  flex justify-center items-center ${
              toggle === false ? "opacity-0" : "opacity-100"
            } lg:opacity-100`}
          >
            <div className="flex flex-col  gap-4 py-10 mt-4 pl-6 bg-gray-200 ">
              ...
              <Link href={"/dashboard"}>
                <div
                  className={`w-[80%]  flex gap-3 items-center rounded-lg p-2 ${
              ...
              <Link href={"/table"}>
                ...
                >
                  ...
                  >
                    <BiSolidDashboard
                      className=" text-black  text-2xl"
                      color={`${pathname == "/table" ? "white" : "black"}`}
                    />
                  </div>
                  <div>
                    <h1>Table</h1>
              ...
              <Link href={"/billing"}>
                ...
                >
                  ...
                  >
                    <BiSolidDashboard
                      className=" text-black  text-2xl"
                      color={`${pathname == "/billing" ? "white" : "black"}`}
                    />
                  </div>
                  <div>
                    <h1>billing</h1>
              ...
              <Link href={"/rtf"}>
                ...
                >
                  ...
                  >
                    <BiSolidDashboard
                      className=" text-black  text-2xl"
                      color={`${pathname == "/rtf" ? "white" : "black"}`}
                    />
                  </div>
                  <div>
                    <h1>RTF</h1>
      ...
      <div className="w-full  bg-gray-200 p-6 ">
        <div className="w-full flex sm:justify-between sm:pb-10 pb-4  px-7 flex-col sm:flex-row">
          <div>
            <h2 className="flex items-center gap-2">
              Pages <BiRightArrowAlt /> {pathname.split("/")[1]}
            </h2>
        ...
        <div className="flex w-full items-center sm:justify-evenly h-[50vh]   md:h-[22vh] pb-10 2xl:pb-0 flex-col sm:flex-row gap-4 sm:flex-wrap">
          <div className=" mt-4 w-[270px] sm:mt-0 sm:w-[300px] md:w-[40%] xl:w-[20%]  2xl:w-[20%]   rounded-xl bg-white flex p-2 items-center justify-between">
            ...
            <div
              ...
              style={{
                backgroundImage:
                  "linear-gradient(to right top, #00A3B1, #00A3B1, #49bdc7, #00A3B1, #00A3B1)",
              }}
            >
        ...
        <div className=" w-full h-full sm:flex sm:flex-row gap-12 sm:gap-6 justify-center items-center flex-col mt-4 2xl:mt-0 lg:gap-4 md:gap-5">
          ...
          <div
            className="py-4 sm:w-[49%] sm:h-[50vh] md:h-[54vh] lg:h-[57vh] rounded-2xl xl:h-[62vh] 2xl:h-[69vh] mt-4 sm:mt-0  flex justify-center items-center"
            style={{
              backgroundImage:
                "linear-gradient(to right top, #00A3B1, #00A3B1, #49bdc7, #00A3B1, #00A3B1)",
            }}
        ...
        <div className="mt-10 sm:flex sm:flex-row gap-4 w-full flex-col">
          ...
          <div className="sm:w-[50%] w-full   bg-white flex flex-col gap-3 p-4 rounded-xl mt-4 sm:mt-0 ">
            <div>
              ...
              <p className="text-sm">
                this month <span className="text-green-700">20%</span>
              </p>
            </div>
            <div className="flex flex-col gap-4">
              ...
              <div className="flex gap-6">
                ...
                <div className="flex flex-col gap-1">
                  <p className="text-sm">New order #46282344</p>
        ...
        <div className="w-full h-[30vh]  mt-3 sm:flex sm:flex-row sm:justify-center gap-6 flex-col ">
          ...
          <div className="sm:w-[39%] w-full bg-white rounded-xl shadow-xl p-4 flex justify-center flex-col  gap-2 px-6 h-[30vh] mt-4 sm:mt-0 ">
            <div
              className=" bg-white rounded-xl shadow-xl  flex justify-center flex-col  gap-3 px-6 h-[30vh] "
              style={{
                backgroundImage:
                  "linear-gradient(to right top, #00A3B1, #00A3B1, #49bdc7, #00A3B1, #00A3B1)",
              }}
            >
              <p className="text-xs sm:text-3xl text-white font-bold">
                Work with the best
              </p>
